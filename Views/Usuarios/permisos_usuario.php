                ...
                <div class="col-12">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-8 col-xxl-9 mt-2 mt-md-0 text-md-end">
                      <button type="submit" class="btn btn-primary mr-2"><i class="fa-solid fa-check"></i> &nbsp Guardar cambios</button>
                      <a href="<?= base_url() ?>Usuarios/permisos_personalizados" class="btn btn-outline-dark"><i class="feather-x-circle"></i> &nbsp Cancelar</a>
                    </div>
                  </div>
                </div>
