      ...
      <div class="container-xl px-4">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <button title="Agregamos un nuevo nivel" class="btn btn-green btn_agregar_niveles"><i class="feather-plus"></i> &nbsp Agregar</button>
    ...
    <div class="container-xl px-4">
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="card">
            <div class="card-header">
              Configuración de los niveles del documento
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table id="tb_niveles" class="display compact w-100">
                  <thead>
                    <tr>
        ...
        <div class="d-none d-md-block text-center col-md-4">
          <img class="img-fluid w-75" src="<?= media() ?>/images/niveles.png" alt="">
        </div>
      </div>
    </div>
  </main>
  <?php footerAdmin($data);
  getModal('modal_niveles', $data);
  ?>